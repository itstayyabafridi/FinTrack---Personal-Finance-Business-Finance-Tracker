...
import { Plus, Search, Landmark, DollarSign, ArrowUpRight, TrendingUp, TrendingDown } from "lucide-react";
  ...
  return (
    <div className="page-container">
      <section className="page-heading">
        <div>
          <div className="eyebrow">Loans / Qarza</div>
          <h1>Loans / Qarza</h1>
          <p>Track borrowed amounts, repayments, and outstanding balances.</p>
        </div>
      ...
      <div className="module-card card-surface">
        ...
        <div className="empty-table">
          ...
          <div>
            <h3>Your loans / qarza workspace is clear</h3>
